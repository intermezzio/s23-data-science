...
- What is the distribution of nu values received?
  - The nu values range from 0.31 to 0.0331, although more information can
  help determine more about the distribution.
...
- The nu values seem to have an almost uniform distribution, although more tests
with more estimated nu values may help determine whether this is uniform, normal,
...
- Does this graph support or contradict the claim above?
  ...
  - Elasticity is similar for thicknesses less than or equal to 0.064 and
    lower for the 0.081 thickness.
  - This change in elasticity with thickness indicates that thickness affects
    elasticity and therefore it's not an intensive property of the metal.
