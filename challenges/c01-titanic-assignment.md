...
- If yes, what might account for those differences?
  - Variation in estimations from 100 years ago can account for what
    appears to be a 1% difference in the estimated total
...
(It looks like I did forget this when trying to account for Age in my
previous exercise.)
