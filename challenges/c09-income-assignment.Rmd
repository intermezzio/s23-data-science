...
- Document your observations here.
  ...
  - Nantucket has a large range of household incomes compared to the rest of
  the counties.
...
- What *overall* trend do you see between `SE` and population? Why might this trend exist?
  ...
  exist because with a higher population, more data can be collected to create
  a more accurate sample for a given county.
