...
- Is there “one true value” for the material properties of Aluminum?
  - No, the values of E and nu vary.
- How many aluminum alloys are in this dataset? How do you know?
  - one because there is only one unique value in the alloy column.
- What angles were tested?
  - The angles tested were 0, 45, and 90 degrees.
- What thicknesses were tested?
  - The thicknesses tested were 0022, 0.032, 0.064, 0.081 (inches?).
- What is the distribution of nu values received?
  - The nu values range from 0.31 to 0.0331, although more information
    can help determine more about the distribution.
...
- The nu values seem to have an almost uniform distribution, although
  more tests with more estimated nu values may help determine whether
  this is uniform, normal, or something completely different.
