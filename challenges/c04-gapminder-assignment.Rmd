...
- There are outliers with higher GDP per capita than the average but no outliers
  with a lower GDP per capita than average.
...
- Wow, the USA has the highest GDP by far of all of these countries. If we
