...
- The sampling distribution has a mean of about 0.5
- The distribution looks like an isosceles triangle from 0 to 1 but I could be
convinced that it's normal
...
se_q2.1 <- 1 # Population: norm(mean = 2, sd = 4), samples: n = 16
...
- Setting q2.1 will have more accurate estimates because the decrease in
standard deviation will make the samples more precise in measuring the
population.
...
- The se_sample standard error is about 20% lower than the population's
standard error.
- This heavily relies on the standard deviation of the sample, which can
vary.
