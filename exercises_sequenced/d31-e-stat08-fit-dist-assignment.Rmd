...
mean_est <- mean(df_data_norm$x)
sd_est <- sd(df_data_norm$x)
mean_est
sd_est
```
...
- The mean is exactly the same but the standard deviation is slightly different,
my guess is it uses a population standard deviation instead of a sample standard
deviation
...
pr_est <- pnorm(2, mean=df_q2$estimate[[1]], sd=df_q2$estimate[[2]])
