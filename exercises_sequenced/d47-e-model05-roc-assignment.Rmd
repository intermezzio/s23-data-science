...
- Is this an effective or ineffective classifier? How do you know?
  - Ineffective because it's close to the line
...
- Is this an effective classifier? 100%
- What explains this model's performance? Is this model valid for prediction? It knows all
...
##
fit_q4 <- glm(
  formula = heart_disease ~ restecg + sex + cp + trestbps,
  data = df_train,
  family = "binomial"
)
df_q4 <-
