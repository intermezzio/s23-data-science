...
- Do you see any coherent patterns in the points? Does this make sense?
  - They're mostly closer to the main
...
- What patterns do you notice?
  - Over time measurement offset changes
...
df_q4 <-
  ...
  summarize(
    Y_mean = mean(Y),
    date = min(date),
    group = (row_number(Y) - 1) %/% n_group
  )
## Control limits and grand mean; complete this code
Y_mean <- mean(df_mass$Y)
Y_sd <- sd(df_mass$Y)
