...
- Is the bolded response **active** or **passive**? Why?
  - The bolded response is active because it directly addresses the previous comment.
- Is the bolded response **constructive** or **destructive**? Why?
  - The bolded response is constructive because it conveys positive emotion and resolves the issue.
- How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?
  - This makes me feel valued as the feedback is properly addressed in a good way.
...
- Is the bolded response **active** or **passive**? Why?
  - The response is passive because it does little to address the concern.
- Is the bolded response **constructive** or **destructive**? Why?
  - The response is constructive because it conveys positive emotion in acknowledging the issue.
- How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?
  - This leaves me confused, as the graph is still unlabeled and ambiguous.
...
- Is the bolded response **active** or **passive**? Why?
  - This is active passive because it doesn't actively build on the previous statement.
- Is the bolded response **constructive** or **destructive**? Why?
  - This is destructive because it is irrelevant information that seems to question the premise of analyzing this data as a whole.
