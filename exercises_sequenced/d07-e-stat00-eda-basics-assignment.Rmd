...
**Observations**:
- This is not true as the Ideal cut is most common.
...
**Observations**:
- This is not an effective graph because the points overlap and don't make the distribution clear.
...
**Observations**:
- This is npt true, as the ideal cuts have a lower median price and quartile range than the others.
- However, there may be confounding variables (like clarity and size) that are not adjusted for
in this plot. Maybe ideal cuts tend to be smaller!
...
**Observations**:
- As I guessed in the last question, the ideal cuts do tend to have fewer carats.
