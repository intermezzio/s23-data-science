...
- The columns are weird because there are a lot of empty / sparse rows in the
first few actual rows of the spreadsheet that don't contain any data or columns
yet
