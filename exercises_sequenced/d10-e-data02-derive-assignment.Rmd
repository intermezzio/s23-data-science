...
Both do the same thing, the pipe one better follows style guides as it
makes the data more usable for future operations before assignment.
...
Instead of one mean price for the whole dataset, it's the mean of each
...
-   The more ideally cut ones have more cov in price.
