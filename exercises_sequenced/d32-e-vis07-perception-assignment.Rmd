...
- Hard to read, why even use cty as a quantitative metric
...
- What are some issues with this graph?
- Reminds me of a graph I made once
- Size of dots is a hard metric to read
- a matrix of points wastes 2 axes
...
- No title
- No place to start
- Ticks outside the graph are confusing
